/**
 * @license AngularJS v1.3.3-local+sha.2474173
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.3.3-local+sha.2474173/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.3.3-local+sha.2474173',    // all of these placeholder strings will be replaced by grunt's
